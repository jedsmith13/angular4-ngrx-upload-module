...
@Component({
  ...
  template: `
    ...
    <div class="preview-container">
      <div class="image-preview-content" ngrxUploadDynamicScroll [count]="files.length" [size]="250">
        <mat-card class="preview-card" *ngFor="let file of files">
          ...
          <div class="image-content hide">
            <img mat-card-image class="preview-image"
                 ngrxUploadProcessImageBuffer
                 [imageBuffer]="file.buffer"
                 (onImageLoaded)="onImageLoaded($event, myLoader._elementRef.nativeElement)">
