...
@Directive({
  selector: '[ngrxUploadDragAndDrop]'
})
export class DragAndDropDirective {
  @HostBinding('class.file-over-zone')
  fileOverZone = false;
   ...
   */
  @Output()
  onDropFile: EventEmitter<any> = new EventEmitter<any>();
   ...
   */
  @Output()
  onFileOverZone: EventEmitter<any> = new EventEmitter<any>();
   ...
   */
  @Output()
  onFileLeaveZone: EventEmitter<any> = new EventEmitter<any>();
