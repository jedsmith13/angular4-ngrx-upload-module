import { Directive, Input, EventEmitter, ElementRef, OnChanges, SimpleChanges, Output } from '@angular/core';

const CLASS = 'ProcessImageBufferDirective';

@Directive({
    selector: "[process-image-buffer]"
})
export class ProcessImageBufferDirective implements OnChanges {
    ...
    private _processImageBuffer(imageBuffer) {
        ...
        reader.onload = (event)=> { setTimeout(()=> {
